...
// Range represents a Unicode code point range
type Range struct {
	Lo   rune
	Hi   rune
	Name string
...
// Ranges defines all Unicode ranges
var Ranges = []Range{
...
// FindRange returns the Unicode range for a given rune.
func FindRange(r rune) *Range {
